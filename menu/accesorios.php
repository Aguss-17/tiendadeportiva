...
try {
    // Id de categoría de accesorios
    $idCategoriaAccesorios = 4;
    ...
    $sentenciaSQL->bindValue(':id_categoria', $idCategoriaAccesorios, PDO::PARAM_INT);
    ...
    $totalSQL->bindValue(':id_categoria', $idCategoriaAccesorios, PDO::PARAM_INT);
    $totalSQL->execute();
...
<section style="background-color: #dec19e; padding: 20px 0;">
    ...
    <div class="text-center mb-2">
        <img src="../img/banneraccesorios.jpg" class="img-fluid" alt="banner accesorios">
    </div>
    ...
    <section class="container">
        <div class="row justify-content-center g-4">
            ...
            <h2 class="text-center mb-1">
                ...
                <span class="d-block fs-4" style="color: #7a5c44;">PARA ACCESORIOS</span>
            </h2>

            <?php if (!empty($productos)): ?>
                <?php foreach ($productos as $producto):
                    $talles = !empty($producto['talles']) ? explode(",", $producto['talles']) : [];
                    $colores = !empty($producto['colores']) ? explode(",", $producto['colores']) : [];
                ?>
