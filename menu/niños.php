...
try {
    ...
    $sentenciaSQL->bindValue(':id_categoria', $idCategoriaNinos, PDO::PARAM_INT);
    ...
    $totalSQL->bindValue(':id_categoria', $idCategoriaNinos, PDO::PARAM_INT);
    $totalSQL->execute();
...
<section style="background-color: #dec19e; padding: 20px 0;">
    ...
    <div class="text-center mb-2">
        <img src="../img/bannerniños.jpg" class="img-fluid" alt="banner niños">
    </div>
    ...
    <section class="container">
        <div class="row justify-content-center g-4">
            ...
            <h2 class="text-center mb-1">
                ...
                <span class="d-block fs-4" style="color: #7a5c44;">PARA NIÑOS</span>
            </h2>
